...
The project is part of the IDX Exchange 12-week NLP internship. The objective is to build a production multi-agent AI assistant for real estate listing using MLS data.
