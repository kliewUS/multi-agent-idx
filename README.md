...
----
Progress:
Week 0 - Successfully setup Openclaw and integrated into WhatsApp. Results can be seen in the week-0 folder. Also, I was able to successfully setup the MySQL Database and import both datasets into the database.
Week 1 - TBD