...
# Note: Modify query to intake more than 5000 embeddings.
query = """
...
def ingest_listings(batch_size=500):
    ...
    # Compute local embeddings in batches
        ...
        print(f"Successfully ingested batch {i + batch_size}!")

    print(f"Successfully ingested {total_recs} listings into ChromaDB.")
