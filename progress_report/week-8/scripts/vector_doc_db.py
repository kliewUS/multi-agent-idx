...
pdf_files = ["./docs/Zillow_Real_Estate_Terms.pdf", 
             "./docs/realestateglossary.pdf", 
             "./docs/Total_Mortage.pdf",  
             "./docs/AI_Agentic_Engineer_Intern_Handbook_2026.pdf",
             "./docs/Real_Estate_Primer.pdf",
             "./docs/Trestle_Propety.pdf",
             "./docs/market_summary_ex.pdf",
             "./docs/mls_tables.pdf"]
...
for file_path in pdf_files:
    if os.path.exists(file_path):
        if file_path == ("./docs/AI_Agentic_Engineer_Intern_Handbook_2026.pdf" 
                        or "./docs/market_summary_ex.pdf"
                        or "./docs/mls_tables.pdf") :
