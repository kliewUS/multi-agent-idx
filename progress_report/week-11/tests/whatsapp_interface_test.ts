...
async function testWhatsApp(query: string, userId: string){
...
// Email Draft test
await testWhatsApp("Create an email draft based on my listing and market results.", "+23366704334");

// Email Deny test
await testWhatsApp("I do not like the draft. Cancel it.", "+23366704334");

// Email Deny without any pending draft
await testWhatsApp("I do not like the draft. Cancel it.", "+23366704334");

// Email Approve without any pending draft.
await testWhatsApp("That looks good, go ahead and send the email.", "+23366704334");

// Email Draft + Approve Test
await testWhatsApp("Create an email draft based on my listing and market results.", "+23366704334");
await testWhatsApp("That looks good, go ahead and send the email.", "+23366704334");
