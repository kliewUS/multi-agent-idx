...
export async function marketStatsAgent(query: string) { // Need to figure out a way to get the city and number of hours out of the query, since this will cause an issue in the mixed query.
    const parsedFilters = await parsePropertyQuery(query);
